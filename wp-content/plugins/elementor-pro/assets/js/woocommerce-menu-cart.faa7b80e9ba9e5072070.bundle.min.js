                ...
                refreshFragments(e) {
                    ...
                    jQuery.each(elementorFrontend.documentsManager.documents, (e) => {
                        ...
                        jQuery.ajax({
                            ...
                            context: this,
                            data: { action: "elementor_menu_cart_fragments", templates: n, _nonce: ElementorProFrontendConfig.woocommerce.menu_cart.fragments_nonce, is_editor: elementorFrontend.isEditMode() },
                            success(e) {
                                e?.fragments &&
