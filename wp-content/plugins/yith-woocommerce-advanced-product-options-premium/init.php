...
! defined( 'YITH_WAPO_VERSION' ) && define( 'YITH_WAPO_VERSION', '3.0.2' );
! defined( 'YITH_WAPO_SCRIPT_VERSION' ) && define( 'YITH_WAPO_SCRIPT_VERSION', '3.0.2' );
...
! defined( 'YITH_WAPO_SECRET_KEY' ) && define( 'YITH_WAPO_SECRET_KEY', '79ec684eb95bbd822fa1b06b7a2631b5' );
